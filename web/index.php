...
Hello
  ...
  <div style="border: 3px solid; padding: 10px; border-color: <?php echo htmlspecialchars($_GET['my-color']); ?>; border-radius: border-color: <?php echo htmlspecialchars($_GET['my-range']); ?>">  
